...
mkdir -p 007.1_1._Semester/{007.11_ADS,007.12_Analysis,007.13_DS,007.14_MuP,007.15_TI1}
mkdir -p 007.2_2._Semester/{007.21_ADS2,007.22_Linear,007.23_Logik,007.24_MuP2,007.25_OOP}
mkdir -p 007.3_3._Semester/{007.31_Automata,007.32_DBS,007.33_Kommunikation,007.34_Software_Technik,007.35_Wahrscheinlichkeit}
